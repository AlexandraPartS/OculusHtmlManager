...
export class StreamClientScrcpy
    ...
    public startStream({ udid, player, playerName, videoSettings, fitToScreen }: StartParams): void {
        ...
        //[NTC.VULKAN] : remove ToolBox functional
        ...
        //[NTC.VULKAN] : video insertion point
        const divstream = document.getElementById('streamtranslation');
        (divstream !==null)? divstream.appendChild(deviceView) : document.body.appendChild(deviceView);
    ...
    public getMaxSize(): Size | undefined {
        ...
        const width = (body.clientWidth - this.controlButtons.clientWidth) & ~0;
        console.log(`body.clientWidth  :  ` + body.clientWidth + `   this.controlButtons.clientWidth  :  ` + this.controlButtons.clientWidth);
